...
public class PieGraph extends JPanel{
    ...
    protected void paintComponent(Graphics g){
        ...
        g.fillArc(2*widthSegment, 2*heightSegment, 3*widthSegment, 3*heightSegment, 0, (int) (cardioPercentage * DEGREES_IN_CIRCLE + 1));
        ...
        g.fillArc(2*widthSegment, 2*heightSegment, 3*widthSegment, 3*heightSegment, (int) (cardioPercentage * DEGREES_IN_CIRCLE + 1), (int) (strengthPercentage * DEGREES_IN_CIRCLE + 1));
        ...
        g.fillArc(2*widthSegment, 2*heightSegment, 3*widthSegment, 3*heightSegment, ((int) (strengthPercentage * DEGREES_IN_CIRCLE) + (int) (cardioPercentage * DEGREES_IN_CIRCLE) + 1), (int) (sedentaryPercentage * DEGREES_IN_CIRCLE));
